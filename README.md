...
1. Пишу автотесты на новые фичи (UI, API) группы инструментов для обзора ключевых слов для SEO-продвижения;
...
6. Поддерживаю и улучшаю процессы: например, предложила новую систему оценки времени на тестирование задач.

**Технологии и инструменты**: Kotlin, Selenide, retrofit2, TestNG, Allure, git, GitLab, Golang, Jira, Confluence, Clickhouse, cURL.
