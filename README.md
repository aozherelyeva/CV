...
Люблю тестировать сложные многокомпонентные продукты, писать документацию, структурировать знания и автоматизировать рутину. Меня вдохновляет возможность что-то изменить или построить своими руками, но я легко адаптируюсь к уже существующим решениям.
...
### Нетология
**С февраля 2021**
Лектор курса по тестированию ПО.
Готовлю материалы и читаю лекции по клиент-серверному взаимодействию.
